...
-- Use {} and implement a new method if you want to create multiple instances
cWortFilter = inherit(cSingleton);

--[[
	This class is usefull for censoring bad words in senctences. It also filters bypasses like c._u._n_..t.
	
	functions to implement in oder to get this snipped working without MTA San Andreas:
	
	split - splits a string into multiple words (Returns array)
	
	File - File Class. Implement or use lua IO
	(Method: loadBadWords())
]]
